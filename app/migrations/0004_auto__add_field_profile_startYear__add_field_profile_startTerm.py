...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.startYear'
        db.add_column(u'app_profile', 'startYear',
                      self.gf('django.db.models.fields.IntegerField')(default=2012),
                      keep_default=False)

        # Adding field 'Profile.startTerm'
        db.add_column(u'app_profile', 'startTerm',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.startYear'
        db.delete_column(u'app_profile', 'startYear')

        # Deleting field 'Profile.startTerm'
        db.delete_column(u'app_profile', 'startTerm')
