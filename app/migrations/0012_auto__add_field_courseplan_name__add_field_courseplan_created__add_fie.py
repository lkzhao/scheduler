...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoursePlan.name'
        db.add_column(u'app_courseplan', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Course Schedule', max_length=1024),
                      keep_default=False)

        # Adding field 'CoursePlan.created'
        db.add_column(u'app_courseplan', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CoursePlan.last_modified'
        db.add_column(u'app_courseplan', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoursePlan.name'
        db.delete_column(u'app_courseplan', 'name')

        # Deleting field 'CoursePlan.created'
        db.delete_column(u'app_courseplan', 'created')

        # Deleting field 'CoursePlan.last_modified'
        db.delete_column(u'app_courseplan', 'last_modified')
    ...
    models = {
        ...
        u'app.courseplan': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Course Schedule'", 'max_length': '1024'}),
            'schedule': ('annoying.fields.JSONField', [], {'default': '[]', 'null': 'True', 'blank': 'True'}),
            'share': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'subset': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
