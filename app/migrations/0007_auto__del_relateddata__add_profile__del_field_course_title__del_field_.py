...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RelatedData'
        db.delete_table(u'app_relateddata')
        ...
        db.delete_column(u'app_course', 'title')

        # Deleting field 'Course.description'
        db.delete_column(u'app_course', 'description')

        # Adding field 'Course.course_data'
        db.add_column(u'app_course', 'course_data',
                      self.gf('annoying.fields.JSONField')(default={}, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'RelatedData'
        db.create_table(u'app_relateddata', (
            ('course_data', self.gf('annoying.fields.JSONField')(default={}, null=True, blank=True)),
            ('user', self.gf('annoying.fields.AutoOneToOneField')(to=orm['django_facebook.FacebookCustomUser'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'app', ['RelatedData'])
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Course.title'
        db.add_column(u'app_course', 'title',
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Course.description'
        db.add_column(u'app_course', 'description',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'Course.course_data'
        db.delete_column(u'app_course', 'course_data')
